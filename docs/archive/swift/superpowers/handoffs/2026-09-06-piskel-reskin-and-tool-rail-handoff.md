> **보관 문서 · 과거 Swift/Piskel 구현**
> 현재 MVP의 작업 지침이 아닙니다. 원문의 명령, 담당 배정, 경로와 검증 결과는 당시 기록입니다.
> 원래 위치: `docs/superpowers/handoffs/2026-09-06-piskel-reskin-and-tool-rail-handoff.md` · [현재 문서 안내](../../../../README.md)
...
(`CharacterEditorWindowController` (과거 경로: `Sources/Unfold/CharacterEditor/CharacterEditorWindowController.swift`)):
...
`Sources/Unfold/Resources/Editor/unfold-bridge.css` (과거 경로: `Sources/Unfold/Resources/Editor/unfold-bridge.css`)
(361 lines).
...
- The vendored `Sources/Unfold/Resources/Editor/piskel/` directory is **never
  ...
  `PISKEL-VERSION.txt` (과거 경로: `Sources/Unfold/Resources/Editor/PISKEL-VERSION.txt`)):
