...
> 원래 위치: `docs/superpowers/specs/2026-09-06-piskel-dark-reskin-design.md` · [현재 문서 안내](../../../../README.md)
...
캐릭터 에디터는 `CharacterEditorWindowController` (과거 경로: `Sources/Unfold/CharacterEditor/CharacterEditorWindowController.swift`)
...
`unfold-bridge.css` (과거 경로: `Sources/Unfold/Resources/Editor/unfold-bridge.css`)
