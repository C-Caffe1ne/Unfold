> **과거 관찰 기록 · 2026-09-11 · macOS · Cat MVP / 84c8405**
> 체크된 항목만 당시 확인한 결과입니다. 공란은 미검증이며, 현 체크아웃·Windows·Garden의 통과 증거로 확대 해석하지 않습니다.
> 새 검증은 [검증 안내](../verification.md)에 따라 별도 기록합니다. 아래 본문은 당시 기록입니다.
